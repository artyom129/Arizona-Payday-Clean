...
- фиксированное мини-окно с остатком окупаемости;
...
- по просьбе пользователя полностью удалён режим перетаскивания: мини-окно всегда остаётся на исходных координатах;
- `/paymini` теперь просто показывает или скрывает мини-окно, также доступны `/paymini on` и `/paymini off`.
...
| `/paymini on` / `/paymini off` | Включить или выключить мини-окно |
